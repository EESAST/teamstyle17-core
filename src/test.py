...
class GameMaintest(unittest.TestCase):
    ...
    def testSkillShop(self):
        ...
        for x in range(5):
            ...
            self.assertEqual(self.player0.skills,{"shortAttack":5,"longAttack":5,"shield":5,"teleport":5,"visionUp":x+1})
        ...
        for x in range(5):
            ...
            self.assertEqual(self.player0.skills,{"shortAttack":5,"longAttack":5,"shield":5,"teleport":5,"visionUp":5,"healthUp":x+1})
